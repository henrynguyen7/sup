...
response.logo = A(B('Sup'), _class="brand",_href="http://www.supapp.com/")
response.title = request.application.replace('_',' ').title()
response.subtitle = T('')

## read more at http://dev.w3.org/html5/markup/meta.name.html
response.meta.author = 'Henry Nguyen <admin@patono.com>'
response.meta.description = 'Sup'
response.meta.keywords = 'Sup'
response.meta.generator = 'Web2py Web Framework'

## TODO: Insert Google Analytics ID here, per http://google.com/analytics
# response.google_analytics_id = 'UA-50561733-1'

#########################################################################
## Application menu
#########################################################################

response.marketing_menu = [
